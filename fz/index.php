...
<head>
	...
	<!-- <script src="https://cdn.jsdelivr.net/npm/hotkeys-js@3.7.3/dist/hotkeys.min.js"></script> -->
		<!--头部颜色更改mdui-theme-primary-？--菜单颜色更改mdui-text-color-？-->	
</head>
<body class = "mdui-drawer-body-left mdui-appbar-with-toolbar mdui-theme-primary-light-green mdui-theme-accent-pink mdui-loaded mdui-text-color-black">
	<!--背景图片修改-->
<body background=/templates/fz/bg/bg.jpg style=" background-repeat:no-repeat ; background-size:100% 100%;background-attachment: fixed;">
	<!--导航工具-->
...
<script src="https://widget.qweather.net/simple/static/js/he-simple-common.js?v=2.0"></script>			
	...
	c0,0.4,0.3,0.9,1.1,0.8c6.5-2.2,11.1-8.3,11.1-15.5C34.3,8.7,27,1.4,18,1.4z"></path>
	  ...
	  <?php }else{ ?>
		<a class = "mdui-hidden-xs" href="/index.php?c=login" title = "登录后台" target="_blank" class="mdui-btn mdui-btn-icon"><i class="mdui-icon material-icons">account_circle</i></a>
	  <?php } ?>
    </a>
		</div>
	</header>
